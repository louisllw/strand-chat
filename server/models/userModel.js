...
export const findUserPublicById = async (id) => {
  const result = await query(
...
export const isUsernameTaken = async (normalizedUsername, excludeId = null) => {
  const result = await query(
...
export const getUsernameMeta = async (id) => {
  const result = await query(
...
export const findUserIdByNormalizedUsername = async (normalizedUsername) => {
  const result = await query(
    `select id
     from users
...
export const findUsersByNormalizedUsernames = async (normalizedUsernames) => {
  const result = await query(
...
export const updateUserStatusWithProfile = async (id, status) => {
  const result = await query(
    `update users
